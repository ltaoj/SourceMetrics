 ...
 * @version : 1.0
 */
public class FileMetricsFactorsimpl1 implements FileMetricsFactors {

    private SourceParser mParser;

    public FileMetricsFactorsimpl1() {
    ...
    public static final SourceParser getmParser(SourceParser sourceParser) {
        return null;
    }
}
